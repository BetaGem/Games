...
coeffs = [np.array([[-12, 0,-35,-15,-34,-25,-1000,-60,-1000,-30,-30,-100, -9999,-9999,-9999,-9999,-9999,-9999,-9999,-99999],
          ...
          np.array([[-10,-3,-40,-15,-35,-25,-1500,-80,-1500,-40,-30,-1050, -9000,-9000,-9000,-9000,-9000,-9000,-9000,-90000],
...
def show(is_back=0):
    ...
    for i in range(MapL):
        for j in range(MapL):
            if board[i][j]:
                plt.scatter(j+1,i+1,
                            c=colors[board[i][j]],s=500*12/(MapL-1),
                            linewidths=1,edgecolors='k')
    if step:
        plt.scatter(steps[-1][1],steps[-1][0],s=100,c='r',lw=5,marker='+')
